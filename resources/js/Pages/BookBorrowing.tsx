...
export default function BookBorrowing({
    ...
    const handleAddBook = () => {
        ...
        const alreadyAdded = selectedBooks.find(
            (b) => b.id_buku === selectedBook.id_buku,
        );
        if (alreadyAdded) {
    ...
    const handleConfirm = () => {
        ...
        if (selectedBooks.length > 10) {
            toast.error("Maksimal peminjaman adalah 10 buku");
            return;
        }
                            ...
                            <div className="space-y-4">
                                                        ...
                                                        (book) => (
                                                            ...
                                                            >
                                                                <img
                                                                    src={
                                                                        book.cover_img_url ??
                                                                        `https://placehold.co/48x64?text=${encodeURIComponent(book.judul)}`
                                                                    }
                                                                    alt={
                                                                        book.judul
                                                                    }
                                ...
                                <div className="border-t pt-4">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setLamaPeminjaman(e.target.value)
                                        }
                                    ...
                                    <div className="flex items-center gap-2 mt-2 text-amber-600">
                                        ...
                                        <span className="text-sm">
                                            Berlaku untuk semua buku (maks. 3
                                            hari)
                                        </span>
                                    </div>
                                </div>
                                    ...
                                    {selectedBooks.map((book) => (
                                        ...
                                        >
                                            <img
                                                src={
                                                    book.cover_img_url ??
                                                    `https://placehold.co/64x80?text=${encodeURIComponent(book.judul)}`
                                                }
                                                alt={book.judul}
